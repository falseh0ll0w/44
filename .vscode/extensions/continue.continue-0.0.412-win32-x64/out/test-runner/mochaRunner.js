...
var mochaRunner_exports = {};
__export(mochaRunner_exports, {
  run: () => run
});
module.exports = __toCommonJS(mochaRunner_exports);
var path = __toESM(require("path"));
var import_mocha = __toESM(require("mocha"));
var glob = __toESM(require_glob());
function run() {
  const timeoutOption = process.env.MOCHA_TIMEOUT ? parseInt(process.env.MOCHA_TIMEOUT) : void 0;
...
//# sourceMappingURL=mochaRunner.js.map
