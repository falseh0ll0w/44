...
exports.CapturedTerminal = void 0;
const vscode = __importStar(require("vscode"));
const os = __importStar(require("os"));
const strip_ansi_1 = __importDefault(require("strip-ansi"));
const lcs_1 = require("../util/lcs");
...
const pty = loadNativeModule("node-pty");
...
class CapturedTerminal {
                ...
                (typeof this.commandPromptString !== "undefined" &&
                    (lastLine.includes(this.commandPromptString) ||
                        this.commandPromptString.length -
                            (0, lcs_1.longestCommonSubsequence)(lastLine, this.commandPromptString)
                                .length <
                            3))));
    }
    async waitForCommandToFinish() {
        return new Promise((resolve, reject) => {
            this.onDataListeners.push((data) => {
                const strippedData = (0, strip_ansi_1.default)(data);
    ...
    constructor(options, onCommandOutput) {
        this.shellPrompt = undefined;
        this.dataBuffer = "";
        this.onDataListeners = [];
        this.commandQueue = [];
        this.hasRunCommand = false;
        this.splitByCommandsBuffer = "";
        this.runningClearToGetPrompt = false;
        this.seenClear = false;
        this.commandPromptString = undefined;
        ...
        this.ptyProcess.onData((data) => {
            if (this.runningClearToGetPrompt) {
                if ((0, strip_ansi_1.default)(data)
                    .split("\n")
                    ...
                    const strippedLines = (0, strip_ansi_1.default)(data)
                        .split("\r")
                    ...
                    if (commandPromptString.length > 0 &&
                        !commandPromptString.includes("echo")) {
                        this.runningClearToGetPrompt = false;
                        this.seenClear = false;
                        this.commandPromptString = commandPromptString;
                        console.log("Found command prompt string: " + this.commandPromptString);
...
exports.CapturedTerminal = CapturedTerminal;
