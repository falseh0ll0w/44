...
parser.add_argument(
    "directory",
    type=str,
    help="The path to the new project directory. This directory should contain the project files.",
)
parser.add_argument(
...
if args.git:
    check_git()
    init_git(args.directory)

if args.python:
    init_python(args.directory)

if args.requirements:
    install_requirements(args.directory)

if args.check:
    check_installed_packages(args.directory)
